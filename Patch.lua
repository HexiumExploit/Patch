...
function hookmetamethod(v27, v28, v29)
    ...
    assert(type(v28) == "string", "invalid argument #2 to 'hookmetamethod' (index: string expected, got "..type(v28)..")", 2)
    assert(type(v29) == "function", "invalid argument #3 to 'hookmetamethod' (function expected, got "..type(v29)..")", 2)
...
hookmetamethod = function(v11, v12, v13)
...
debug.getupvalue = function(v17, v18)
    local v19
    setfenv(v17, {print = function(v32) v19 = v32 end})
    v17()
    return v19
end
...
function getnamecallmethod()
    return debug.getconstant(1)  -- returns the first constant in the constants table
end

debugconstant = function(index)
    return debug.getconstant(nil, index)  -- retrieves the constant by the provided index
end
